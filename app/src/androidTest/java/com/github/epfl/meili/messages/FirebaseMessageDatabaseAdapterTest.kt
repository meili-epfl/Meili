...
class FirebaseMessageDatabaseAdapterTest {
    ...
    private val fake_message = ChatMessage("fake_id", "fake_text", "fake_from_id", "fake_to_id", 12345)
    ...
    fun adddMessageTest(){
        ...
        val observer = Observer{ _: Observable, _: Any -> assertEquals(expectedList, db.messages)
        }
